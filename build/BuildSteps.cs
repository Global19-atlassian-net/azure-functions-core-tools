...
namespace Build
{
    public static class BuildSteps
    {
        ...
        private static List<string> GetDelaySignedBinaries(string targetDir)
        {
            ...
            string snLocation = "C:\\Program Files (x86)\\Microsoft SDKs\\Windows\\v10.0A\\bin\\Netfx 4.8 Tools\\sn.exe";
            ...
            foreach (string file in files)
            {
                ...
                if (commandOutput.Contains("delay-signed", StringComparison.OrdinalIgnoreCase)
                    || commandOutput.Contains("test-signed", StringComparison.OrdinalIgnoreCase))
                {
